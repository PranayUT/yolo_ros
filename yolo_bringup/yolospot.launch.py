...
def generate_launch_description():
    ...
    def run_yolo(context: LaunchContext, use_tracking, use_3d):
        ...
        input_image_topic_cmd = DeclareLaunchArgument(
            "input_image_topic",
            default_value="/spot/camera/left/image/color/image_raw",
        ...
        input_depth_topic_cmd = DeclareLaunchArgument(
            "input_depth_topic",
            default_value="/spot/depth/left/image",
        ...
        input_depth_info_topic_cmd = DeclareLaunchArgument(
            ...
            default_value="/spot/depth/left/camera_info",
        ...
        target_frame_cmd = DeclareLaunchArgument(
            "target_frame",
            default_value="left_rgbd_optical",
        ...
        color_to_depth_ratio = LaunchConfiguration("color_to_depth_ratio")
        color_to_depth_ratio_cmd = DeclareLaunchArgument(
            "color_to_depth_ratio",
            default_value="0.5",
            description="Ratio used to scale down pixels from color image to depth image",
        )
            ...
            parameters=[
                {
                    ...
                    "color_to_depth_ratio": color_to_depth_ratio,
        ...
        image_republish_node = Node(
            ...
            remappings=[
                ("in/compressed", "/spot/camera/left/image/compressed"),
                ("out", "/spot/camera/left/image/color/image_raw"),
            ],
        )
